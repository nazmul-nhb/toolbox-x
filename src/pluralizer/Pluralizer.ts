 ...
 *
 * @remarks
 * - For simpler pluralization (plural with only 's'), please refer to {@link https://toolbox-x.vercel.app/docs/utils/string/format-unit-with-plural formatUnitWithPlural} instead.
 *
 * - For ready to use instance, please refer to {@link https://toolbox-x.vercel.app/docs/utils/string/pluralizer pluralizer} instead.
 *
 * @example
...
/**
 * Default shared instance of {@link https://toolbox-x.vercel.app/docs/classes/pluralizer Pluralizer}.
 *
 ...
 *
 * @remarks For simpler pluralization (plural with only 's'), please refer to {@link https://toolbox-x.vercel.app/docs/utilities/string/format-unit-with-plural formatUnitWithPlural} instead.
 *
