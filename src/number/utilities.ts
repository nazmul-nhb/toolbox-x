 ...
 */
export function roundToNearest(value: Numeric, interval = 5): number {
 ...
 */
export function getRandomFloat(min: Numeric, max: Numeric): number {
 ...
 */
export function getOrdinal(num: Numeric, withNumber = true): string {
