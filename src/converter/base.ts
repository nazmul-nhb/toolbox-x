...
export class $BaseConverter<Unit extends $Unit> {
	 ...
	 * - For complex and versatile pluralization, please refer to {@link https://toolbox-x.vercel.app/docs/utils/string/pluralizer pluralizer} or {@link https://toolbox-x.vercel.app/docs/classes/pluralizer Pluralizer Class} instead.
	 */
	toString(): string {
	 ...
	 *
	 * @remarks For complex and versatile pluralization, please refer to {@link https://toolbox-x.vercel.app/docs/utils/string/pluralizer pluralizer} or {@link https://toolbox-x.vercel.app/docs/classes/pluralizer Pluralizer Class} instead.
	 */
