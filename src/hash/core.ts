 ...
 * ```
 *
 * @see {@link https://toolbox-x.vercel.app/docs/utils/hash/encoding#sha256bytes sha256Bytes} for hashing raw bytes
 * @see {@link https://toolbox-x.vercel.app/docs/utils/hash/encoding#utf8tobytes utf8ToBytes} for converting string to bytes
 * @see {@link https://toolbox-x.vercel.app/docs/utils/hash/encoding#bytestohex bytesToHex} for converting bytes to a hexadecimal string
 */
