 ...
 * - For fluent, chainable styling with zero configuration use {@link https://toolbox-x.vercel.app/docs/utils/misc/stylog Stylog} (`LogStyler` chainable wrapper).
 *
 * @example
...
export class LogStyler {
	 ...
	 * - If you want to format with ANSI escape codes, consider using {@link https://toolbox-x.vercel.app/docs/classes/log-styler#toansiinput-stringify toANSI} method.
	 *
	 ...
	 * - For unsupported browsers, consider using the {@link https://toolbox-x.vercel.app/docs/classes/log-styler#loginput-stringify log} method to print directly or {@link https://toolbox-x.vercel.app/docs/classes/log-styler#tocssinput-stringify toCSS} to get styled tuple `[format, cssList]` for Browser.
	 *
	 * @param input - Input to style before printing in the shell.
	 * @param stringify - Whether to apply `JSON.stringify()` before styling. Defaults to `false`.
 ...
 * - If you need custom reusable style configurations, use {@link https://toolbox-x.vercel.app/docs/classes/log-styler Stylog} class.
 *
 * @example
 * // Simple color
