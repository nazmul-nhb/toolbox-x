...
description: Extract Total Minutes — Toolbox-X Documentation.
---
...
```typescript
import { getTotalMinutes } from "toolbox-x/date";
```
...
- It internally uses [extractHourMinute](/docs/utils/date-time/extract-hour-minute)
