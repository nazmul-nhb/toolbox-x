...
- [`isNumericString()`](../../guards/primitive/numeric#isnumericstring) - Check if a string contains only digits
- [`isNonEmptyString()`](../../guards/primitive/composite#isnonemptystring) - Check if a string is not empty
