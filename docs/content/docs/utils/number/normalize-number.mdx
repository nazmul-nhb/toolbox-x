...
- [isNumber](../../guards/primitive/core#isnumber) - Guard check for basic numbers.
- [isNumericString](../../guards/primitive/numeric#isnumericstring) - Guard check for numeric strings.
