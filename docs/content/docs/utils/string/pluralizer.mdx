...
The **`pluralizer`** is a **default shared instance** of the [`Pluralizer`](../../classes/pluralizer) class. It comes **preloaded with standard English rules**, irregular forms, and uncountable nouns.
...
- If you need isolated or custom rules, you can instantiate the class directly as [`new Pluralizer()`](../../classes/pluralizer).
</Callout>
...
- [**Pluralizer class**](../../classes/pluralizer) — low‑level API for custom instances.
