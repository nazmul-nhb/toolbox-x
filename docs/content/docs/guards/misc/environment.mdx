...
// Simulate Node.js environment in the browser
const process: Record<string, Record<string, string>> = {
    env: {
...
// Matching cases
console.log(isEnvironment('development'));     // true

// Non-matching cases
console.log(isEnvironment('production'));      // false
```
