...
- You want to **add custom status codes** without affecting the shared [`httpStatus`](../utils/misc/http-status) instance.
...
- [**httpStatus (default instance)**](../utils/misc/http-status) — shared instance of `HttpStatus` for standard use cases.
