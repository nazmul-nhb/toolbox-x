...
- [**formatUnitWithPlural**](../utils/string/format-unit-with-plural) — Simple utility for formatting units with pluralization.
- [**Verbalizer class**](./verbalizer) — Similar class for _verb form_ manipulation.
